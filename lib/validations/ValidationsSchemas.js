...
export const yupRequiredString = Yup.string().required(REQUIRED_MESSAGE);
...
const yupRequiredPhone = Yup.string()
...
export const invitationValidations = Yup.object().shape({
  names: yupRequiredString,
  surnames: yupRequiredString,
  email: yupRequiredEmail,
  role: yupRequiredString,
});

export const invitedValidations = Yup.object().shape({
  names: yupRequiredString,
  surnames: yupRequiredString,
  password: yupRequiredPassword.matches(
    PASSWORD_FORMAT,
